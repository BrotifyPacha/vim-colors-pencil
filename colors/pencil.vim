...
call s:h("DiffAdd",       {"bg": s:black, "fg": s:green})
call s:h("DiffAdded",     {"bg": s:black, "fg": s:green})
call s:h("DiffDelete",    {"bg": s:black, "fg": s:red})
call s:h("DiffRemoved",   {"bg": s:black, "fg": s:red})
call s:h("DiffChange",    {"bg": s:black, "fg": s:dark_yellow})
call s:h("DiffChanged",   {"bg": s:black, "fg": s:dark_yellow})
call s:h("DiffText",      {"bg": s:black, "fg": s:dark_blue})
